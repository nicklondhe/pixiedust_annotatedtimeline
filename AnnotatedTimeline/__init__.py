...
from .display import AnnotatedTimelineHandler
from pixiedust.display.display import *

@PixiedustDisplay()
class AnnotatedTimelineHandlerMeta(DisplayHandlerMeta):
    @addId
    def getMenuInfo(self,entity, dataHandler):
        ...
        return[{"categoryId": "AnnotatedTimelineHandler", "title": "AnnotatedTimelineHandler Plugin", "icon":"fa-gift", "id":"AnnotatedTimelineHandler"}]
    
    """
    Factory method that creates the displayHandler class capable of visualizing the data
    """
    def newDisplayHandler(self,options,entity):
        return AnnotatedTimelineHandler(options,entity)